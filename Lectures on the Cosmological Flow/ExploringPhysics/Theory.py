...
class theory():
	...
	def __init__(self, N, Nfield, interpolated):
		self.N = N
		self.Nfield = Nfield
		self.interpolated = interpolated # (H_f, cs_f, m_f, rho_f, g_f)
	...
	def A_abc(self, k1, k2, k3):
		...
		Aabc[0, 0, 1] += self.g * k1k2/self.a**2 /3
		Aabc[0, 1, 0] += self.g * k1k3/self.a**2 /3
		Aabc[1, 0, 0] += self.g * k2k3/self.a**2 /3
		return Aabc
	...
	def A_abc_fast(self, k1, k2, k3): # For initial conditions
		...
		k1k3 = (k2**2 - k1**2 - k3**2)/2
		k2k3 = (k1**2 - k2**2 - k3**2)/2
		Aabc[0, 0, 1] += self.g * k1k2 /3
		Aabc[0, 1, 0] += self.g * k1k3 /3
		Aabc[1, 0, 0] += self.g * k2k3 /3
		return Aabc
